    ...
    public function __construct() {
        ...
        if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
            ...
            $config = array(
                ...
                'api_url' => 'https://api.github.com/repos/olipayne/varnish-http-purge', // the github API url of your github repo
                'raw_url' => 'https://raw.github.com/olipayne/varnish-http-purge/master', // the github raw url of your github repo
                'github_url' => 'https://github.com/olipayne/varnish-http-purge', // the github url of your github repo
                'zip_url' => 'https://github.com/olipayne/varnish-http-purge/zipball/master', // the zip url of the github repo
